...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='post',
            name='data_post',
            field=models.DateTimeField(default=django.utils.timezone.now, verbose_name='Data Postagem'),
        ),
        migrations.AlterField(
            model_name='post',
            name='excerto_post',
        ...
        migrations.AlterField(
            model_name='post',
            name='imagem_post',
            field=models.ImageField(blank=True, null=True, upload_to='post_img/%Y/%m/%d', verbose_name='Cover'),
        ),
        migrations.AlterField(
            model_name='post',
            name='publicado_post',
